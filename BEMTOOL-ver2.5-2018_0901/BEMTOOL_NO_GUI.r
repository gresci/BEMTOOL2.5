...
#source((paste(getwd(), "/src/load_function.r", sep="")))
print("src/utils/requiredLibs")
(source(paste(getwd(), "/src/utils/requiredLibs.r", sep="")))
print("src/utils/ini")
(source(paste(getwd(), "/src/utils/ini.r", sep="")))
print("src/utils/scripts")
(source(paste(getwd(), "/src/utils/scripts.r", sep="")))

print("gui/scripts")
(source(paste(ALADYM_home, "/gui/scripts.r", sep="")) )
print("gui/ini")
(source(paste(ALADYM_home, "/gui/ini.r", sep="")) )

print("load_functions")
(source(paste(ALADYM_home, "/src/load_functions.r", sep="")) )

print("bmtgui/ini")
(source(paste(getwd(), "/bmtgui/utils/ini.r", sep="")))
print("bmtgui/scripts")
(source(paste(getwd(), "/bmtgui/utils/scripts.r", sep="")))
